...
- **Navigation:**
    ...
    - Flaps Down (next selection) = Seta-cima
    - Flaps Up (previous selection) = Seta-baixo
    - Tail wheel lock/unlock = Num ,
    - Wheel Brake Left/Right = Seta-Esquerda / Seta-Direita
- **Collimator:**
